...
describe("One update on basic drug", () => {
  ...
  it("should decrease the benefit of 2 when expiresIn is less than 0 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Doliprane", -1, 3)).toEqual(
      new Drug("Doliprane", -2, 1),
    );
  });
  it("should decrease the benefit of 2 when expiresIn is equal 0 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Doliprane", 0, 3)).toEqual(
      new Drug("Doliprane", -1, 1),
    );
  });
  it("should decrease only the expiresIn if the benefit is equal 0", () => {
...
describe("One update on Herbal Tea drug", () => {
  ...
  it("should increase the benefit of 2 when expiresIn is equal 0 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Herbal Tea", 0, 3)).toEqual(
      new Drug("Herbal Tea", -1, 5),
    );
  });
  it("should decrease only the expiresIn if the benefit is equal 50", () => {
...
describe("One update on Fervex drug", () => {
  ...
  it("should increase the benefit of 2 when expiresIn is equal to 10 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Fervex", 10, 3)).toEqual(
      new Drug("Fervex", 9, 5),
    );
  });
  it("should increase the benefit of 2 when expiresIn is greater than 5 and less or equal 10 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Fervex", 7, 3)).toEqual(new Drug("Fervex", 6, 5));
  });
  it("should increase the benefit of 3 when expiresIn is equal 5 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Fervex", 5, 3)).toEqual(new Drug("Fervex", 4, 6));
  });
  it("should increase the benefit of 3 when expiresIn is less or equal 5 and more than 0 and benefit is between 0 and 50", () => {
    expect(simulateOneUpdate("Fervex", 4, 3)).toEqual(new Drug("Fervex", 3, 6));
  });
  it("should decrease the benefit to 0 when expiresIn is 0 or less ", () => {
...
describe("One update on Dafalgan drug", () => {
  it("should decrease the benefit of 2 when expiresIn is greater than 0 and benefit is between 0 and 50", () => {
